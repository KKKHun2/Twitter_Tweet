    ...
    Tweet
          ...
          <div className="mt-5 flex">
            ...
            <div className="w-full h-screen">
              ...
              <div className="text-gray-700 ml-3 ">{data?.tweet?.content}</div>
              </div>

            <div className="flex  justify-end  items-center bg-gray-50  rounded-b-md space-x-2 ">
              <button className="mr-3 p-3 rounded-md flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-500">
                <div className="mr-1 ">
                <svg
                  className="h-6 w-6 "
